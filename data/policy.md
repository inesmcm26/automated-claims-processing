...
**Payout:**
- Up to the total bill amount, depending on your policy and documentation
...
**What's required:**
- Proof of theft, loss, or damage, such as a police report or acknowledgement from the airline.

**Payout:**
- Standard payout: €100 per person affected
...
- Calculated based on a formula:
  `Compensation = % of Sum Assured × Booking Value ÷ Number of passengers × Number of affected people`

For this policy, the % of Sum Assured is 50%
